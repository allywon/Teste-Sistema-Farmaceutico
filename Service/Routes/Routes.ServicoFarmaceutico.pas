...
type
  ...
  private
    ...
    procedure RotaServicoById(ARequestInfo: TIdHTTPRequestInfo; AResponseInfo: TIdHTTPResponseInfo; const AId: string);
...
function TServicoFarmaceuticoRoute.ProcessarRota(const APath: string; const AVerb: THTTPVerb;
...
begin
  ...
  if APath = '/api/servicos-farmaceuticos' then
  begin
  ...
  else if APath = '/api/servicos-farmaceuticos/periodo' then
  begin
    if AVerb = hvGET then
    begin
  ...
  else if APath.StartsWith('/api/servicos-farmaceuticos/') then
  begin
...
procedure TServicoFarmaceuticoRoute.RotaServicoById(ARequestInfo: TIdHTTPRequestInfo; AResponseInfo: TIdHTTPResponseInfo; const AId: string);
var
  lId: Int64;
  lBodyJSON: TJSONObject;
  lResult: Boolean;
