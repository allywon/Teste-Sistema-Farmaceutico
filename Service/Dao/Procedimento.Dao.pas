...
constructor TProcedimentoDAO.Create(ADB: TModelDB);
begin
  FDB := ADB;
end;

function TProcedimentoDAO.ListarTodos: TArray<TProcedimento>;
var
  lQuery: TFDQuery;
  lLista: TList<TProcedimento>;
  lProcedimento: TProcedimento;
begin
  lLista := TList<TProcedimento>.Create;
...
function TProcedimentoDAO.BuscarPorId(const AId: Int64): TProcedimento;
var
  lQuery: TFDQuery;
begin
  Result := nil;
...
function TProcedimentoDAO.Inserir(AProcedimento: TProcedimento): Boolean;
var
  lQuery: TFDQuery;
begin
  Result := False;
...
function TProcedimentoDAO.Atualizar(const AId: Int64; AProcedimento: TProcedimento): Boolean;
var
  lQuery: TFDQuery;
begin
  Result := False;
...
function TProcedimentoDAO.Excluir(const AId: Int64): Boolean;
var
  lQuery: TFDQuery;
begin
  Result := False;
...
function TProcedimentoDAO.Carregar(const AId: Int64; AProcedimento: TProcedimento): Boolean;
var
  lQuery: TFDQuery;
begin
  Result := False;
