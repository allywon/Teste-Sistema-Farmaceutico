...
begin
  ...
  try
    lLista := FServicoFarmaceuticoDAO.ListarTodos;
    try
...
var
  lServicoFarmaceutico: TServicoFarmaceutico;
begin
  lServicoFarmaceutico := FServicoFarmaceuticoDAO.BuscarPorId(AId);
  try
...
begin
  ...
  lListaServicos := FServicoFarmaceuticoDAO.ListarTodos;
  try
