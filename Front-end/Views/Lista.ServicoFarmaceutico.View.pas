...
uses
  ...
  System.Generics.Collections, Model.ServicoFarmaceutico, Model.Pessoa,
  Controller.ServicoFarmaceutico, Cadastro.ServicoFarmaceutico.View;
...
uses DateUtils, Controller.Pessoa, ComboBox.Helper;
...
begin
  ...
  begin
    ...
    FLstServicosFarmaceuticos.Filter := EmptyStr;
    Exit;
  end;
...
begin
  TComboBoxHelper.CarregarComboPessoas(cmbFarmaceutico, TPessoaTipo.ptFarmaceutico);
  TComboBoxHelper.CarregarComboPessoas(cmbPaciente, TPessoaTipo.ptPaciente);
  LimparFiltros;
