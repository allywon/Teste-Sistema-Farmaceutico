...
type
  ...
  protected
    ...
    procedure FiltrarRegistros(const ATexto: string); virtual; abstract;
    procedure ConfigurarModoEdicao(AEditando: Boolean); virtual;
  public
    { Public declarations }
  end;
...
procedure TfCadastroPessoaBase.ConfigurarModoEdicao(AEditando: Boolean);
begin
  ...
  dbgPessoas.Enabled := not AEditando;
  edtNome.Enabled := AEditando;
  edtCPF.Enabled := AEditando;
  edtDtNascimento.Enabled := AEditando;
