...
begin
  ...
  begin
    ...
    ShowMessage('Erro ao salvar paciente.' + #13 + FPaciente.Aviso);
end;
...
begin
  ...
  if (not FModoEdicao) and (FController.BuscarPorCPF(ptPaciente, Trim(edtCPF.Text)).Id > 0) then
  begin
    ShowMessage('Já existe um paciente cadastrado com esse CPF!');
    edtCPF.SetFocus;
    Exit(False);
  end;
