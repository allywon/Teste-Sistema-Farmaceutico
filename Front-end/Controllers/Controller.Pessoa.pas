...
type
  ...
  public
    ...
    function BuscarPorCRF(ATipo: TPessoaTipo; const ACRF: String): TPessoaBase;
...
function TPessoaController.BuscarPorCRF(ATipo: TPessoaTipo;
  const ACRF: String): TPessoaBase;
var
  lResource: string;
  lResponseContent: string;
  lJSONObject: TJSONObject;
begin
  ...
  lResource := Format('%s/crf/%s', [GetResourceName(ATipo), ACRF]);
